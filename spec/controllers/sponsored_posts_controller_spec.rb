...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of Sponsored Post by 1" do
            expect{ sponsored_post :create, params: { topic_id: my_topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 0 } } }.to change(SponsoredPost,:count).by(1)
    end

    it "assigns the new post to @sponsored_post" do
            sponsored_post :create, params: { topic_id: my_topic.id, sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 0 } }
    end
  ...
  describe "GET edit" do
    ...
    it "assigns sponsored sponsored_posts to be updated to @post" do
        get :edit, params: { topic_id: my_topic.id, id: my_sponsored_post.id }
